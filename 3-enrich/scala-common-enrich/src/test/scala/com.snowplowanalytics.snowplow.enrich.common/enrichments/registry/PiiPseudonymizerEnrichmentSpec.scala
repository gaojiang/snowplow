...
class PiiPseudonymizerEnrichmentSpec extends Specification with ValidationMatchers {
  ...
  private val ipEnrichment = IpLookupsEnrichment(
    Some(("geo", new URI("/ignored-in-local-mode/"), "GeoIPCity.dat")),
